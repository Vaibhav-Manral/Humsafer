...
const SideBar: React.FC<IProps> = (props) => {
    ...
    const {collapseLogo} = useContext(HumsaferThemeContext);
    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            >
                <div className={classNames(styles.root, props.collapsed ? styles.collapsed : '')}
                     style={{backgroundColor: "#FFF"}}>
                    <div className={styles.header}>
                        {props.collapsed ? <span onClick={() => props.setCollapsed(!props.collapsed)}
                                                 className={styles.toggleBtn}><span>
                  <img src={collapseLogo} alt={"logo"} className={styles.collapsedImg}/>
                </span></span>
                            : <>
                                <Link to="/">
